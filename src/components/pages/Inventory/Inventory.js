...
const Inventory = () => {
    ...
    return (
        <div>
            <div className='w-1/3 mx-auto mt-10 p-8 text-black bg-rose-50 rounded-md'>
                ...
                <p className='text-2xl font-semibold my-2'>Quantity: {phone.quantity>0?phone.quantity:'Stock Out'}</p>
                <button onClick={handleDeliveredBtn} className='bg-rose-500 px-8 py-2 rounded-md text-white'>Delivered</button>
            </div>

            <div className='w-2/3 my-10 mx-auto p-8 bg-rose-50 rounded-md text-black'>
                ...
                <form onSubmit={handleQuantityStock}>
                    ...
                    <br />
                    <button className='bg-rose-500 px-8 py-2 rounded-md text-white'>Restock</button>
                </form>
                <br />
